...
export const FALLBACK_ALERTS = [
  {
    ...
    severity: 'HIGH',
    risk_score: 0.72,
    message: 'High landslide probability in Mangan - Teesta Valley due to intense rainfall.',
    evidence_json: { rainfall_24h: 145.0, soil_moisture: 0.85 },
    status: 'active',
