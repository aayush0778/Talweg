...
export const MapWorkspacePage: React.FC = () => {
  ...
  return (
    <div className="flex flex-col h-full w-full bg-ink-950 text-slate-100 overflow-hidden select-none">
      {/* Top Navigation / System Status Header (embedded — the dashboard shell owns branding) */}
      <Header
        health={health}
      ...
      <main id="main-content" tabIndex={-1} className="relative flex-1 w-full h-full overflow-hidden focus:outline-none">
        ...
        {hazardProgressionData && (
          <HazardProgressionPlayer
            ...
            rightInset={isDesktop ? width : undefined}
          />
        )}
      </main>
    </div>
